  ...
  return (
    <>
      ...
      <S.Container>
        ...
        <S.Description>
          As a music producer, I'm frequently looking for new sounds to use in
          my music. It isn't always obvious where to find these sounds, or even
          what I'm looking for. Sometimes, I just want to be surprised (or
          lazy). Using the Freesound.org API, I can find inspiration
          effortlessly.
        </S.Description>
        ...
        <S.Description>
          ...
          the app feels more like an instrument than a random sound player.
          Using the built-in HTML audio controls, users can loop the audios
          simultaneously, giving them a tool for combining sounds on the fly.
          This for me has resulted in hours of fun, and countless interesting
          sound textures. The HTML audio controls provide a ton of functionality
          to suit this application, including volume control, playback speed,
          play/pause, and even the ability to download files. A search bar was
          added for intentional sound foraging, and the entire set of sounds can
          be saved in local storage with a preset name.
        </S.Description>
        <S.GIF
          src={screenRecordingDemo2}
          autoPlay
          type="video/mp4"
          loop
        ></S.GIF>
        ...
        <S.Description>
          ...
          feeling to every new batch of sounds. Recently, a user requested that
          a link to the background video be added, so that they could use it in
          a visual production. It feels great to be able to help people find
          creative inspiration, even in domains beyond the application's
          original intention.
        </S.Description>
